...
export function PerformanceToggle({ currentMode, onModeChange }: PerformanceToggleProps) {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute top-full right-0 mt-2 w-80 bg-white/95 backdrop-blur-md rounded-lg shadow-xl border border-gray-200 overflow-hidden z-[100] animate-in slide-in-from-top-2 fade-in">
